...
SUITE(GPSHandler) {
  ...
  TEST_FIXTURE(GPSHandlerFixture, TestIngestionRecovery)
    {
      char *gpgga = "$GP this is not gps whee \002\077@!#$%&$$$GPGGA,021741,3745.5748,N,12224.9648,W,2,09,1.0,20.2,M,-32.1,M,,*48\n";
      int i;
  ...
  TEST_FIXTURE(GPSHandlerFixture, TestParse)
    {
      char *gpgga = "$GP this is not gps whee \002\077@!#$%&$$$GPGGA,081741,3745.5748,N,12224.9648,W,2,09,1.0,20.2,M,-32.1,M,,*48\n";
      int i;
